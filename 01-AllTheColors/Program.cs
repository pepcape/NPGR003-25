...
/*
 * This is just an example how to use the ImageSharp library (raster image manipulation)
 * and the CommandLineParser library (command-line parsing).
 *
 * Feel free to be inspired byt the code, but you don't need to base your solution
 * on this project!
 *
